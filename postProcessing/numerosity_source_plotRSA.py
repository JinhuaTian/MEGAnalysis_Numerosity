...
brain = rsa_vals.plot(subjects_dir=subjects_dir,hemi='both', initial_time=0,
                 clim=dict(kind='value', lims=[3, 6, 9]),time_viewer=True)
movieFname = pj(rootDir,'my.mp4')
brain.save_movie(time_dilation=20, tmin=0, tmax=0.6,
